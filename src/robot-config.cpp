...
motor LeftIntake = motor(PORT7, ratio36_1, false);
motor RightIntake = motor(PORT12, ratio36_1, true);
...
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 319.19, 317.5, 254, mm, 1);
